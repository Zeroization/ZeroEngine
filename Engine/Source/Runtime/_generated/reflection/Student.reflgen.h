...
namespace ZeroEngine::Reflection
{
    ...
    static void TypeWrapperRegister_Student()
    {
        ...
        ZERO_REFL_REGISTER_VARIABLE(Student, Student::mClassID, &Student::mClassID);
        ...
        ZERO_REFL_REGISTER_VARIABLE(Student, Student::mGender, &Student::mGender);
        ...
        ZERO_REFL_REGISTER_FUNCTION(Student, Student::SetClassIDAndGender, &Student::SetClassIDAndGender, void, int, bool);
